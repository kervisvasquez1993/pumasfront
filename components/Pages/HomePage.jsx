      ...
      <div className=' container'>
        ...
        <TwoColumnGrid backgroundImage='/images/mask-background.png'>
          <BasicSection
            ...
            styleContent={{ height: '100%' }}
          >
            <ReactMarkdown className='sm:m-lg:py-10 md:py-55 m-responsive highlight'>
              {section2?.content}
            </ReactMarkdown>
            <Link
              href={lang + '/' + section2?.btn.url}
              className='text-orange-500 font-black'
            >
              {obtenerFrase(lang, 'illustration3d')}
            </Link>
            <ButtonView
        ...
        <HeaderComponets
          classNameText={'p-10 titleGreen chelseaFont font-responsive hidden'}
