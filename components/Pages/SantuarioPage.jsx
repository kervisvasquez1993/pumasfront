          ...
          <div className="grid-2">
            ...
            <div className="about-sanctuary_text">
              <p>
                ...
                por sí mismos o que fueron mantenidos ilegalmente como mascotas
                y se acostumbraron a vivir con las personas.
              </p>
              <p>
                Cada animal tiene un recinto ambientado naturalmente y cada uno
                de ellos tiene una historia detrás de su rescate que explica el
                por qué deben vivir en cautiverio.
              </p>
              <p>
                ...
                silvestre y las amenazas que enfrentan como la pérdida de
                hábitat, la caza y la tenencia ilegal.
                <a href="#">
          ...
          <div className="icons-container">
            <div className="flex-2">
              ...
              <div className="icons_text">
                <p>No tocar, molestar ni alimentar a los animales</p>
              </div>
            </div>
            <div className="flex-2">
              <div className="icons__imagen">
              ...
              <div className="icons_text">
                <p>Respetar lasbarandas de seguridad</p>
              </div>
            </div>
            <div className="flex-2">
              <div className="icons__imagen">
              ...
              <div className="icons_text">
                <p>No usar flash en fotos o videos</p>
              </div>
            </div>
            <div className="flex-2">
              <div className="icons__imagen">
